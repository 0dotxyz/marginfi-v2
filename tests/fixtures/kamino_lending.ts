...
export type KaminoLending = {
  ...
  instructions: [
    ...
    },
    {
      ...
      accounts: [
        {
          name: "owner";
          docs: ["The depositor holding ctokens."];
          writable: true;
          signer: true;
        },
        {
        ...
        },
        {
          ...
          docs: ["The source of collateral to be enqueued."];
          writable: true;
        },
        {
    ...
    },
    {
      ...
      accounts: [
        ...
        {
          name: "reserveLiquidityMint";
          docs: ["The liquidity mint, needed to invoke the transfer."];
        },
        {
          name: "reserveCollateralMint";
          docs: [
    ...
    },
    {
      ...
      accounts: [
        ...
        {
          name: "reserve";
          docs: ["The reserve, needed only to validate the other accounts."];
        },
        {
          name: "reserveCollateralMint";
          docs: ["The collateral mint, needed to invoke the transfer."];
        },
        {
          name: "ownerQueuedCollateralVault";
          docs: [
  ...
  accounts: [
    ...
    {
      name: "withdrawTicket";
      discriminator: [237, 23, 164, 58, 53, 248, 240, 94];
    }
  ];
  events: [
    {
      name: "borrowOrderCancelEvent";
      discriminator: [88, 228, 231, 230, 234, 248, 69, 144];
    },
    {
      name: "borrowOrderFullFillEvent";
      discriminator: [177, 241, 237, 250, 143, 20, 14, 183];
    },
    {
      name: "borrowOrderPartialFillEvent";
      discriminator: [113, 81, 252, 193, 152, 24, 99, 84];
    },
    {
      name: "borrowOrderPlaceEvent";
      discriminator: [43, 211, 208, 186, 94, 227, 218, 198];
    },
    {
      name: "borrowOrderUpdateEvent";
      discriminator: [21, 33, 67, 131, 48, 184, 90, 64];
    }
  ];
  errors: [
    {
  ...
  types: [
    ...
    {
      name: "withdrawQueue";
      docs: ["A tracker of ticket-based withdrawals."];
      type: {
        kind: "struct";
        fields: [
          {
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: "withdrawQueue";
            docs: ["The tracker of ticket-based withdrawals."];
            type: {
              defined: {
                name: "withdrawQueue";
              };
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: "reserve";
            docs: ["The reserve to withdraw from."];
            type: "pubkey";
          },
          {
            name: "userDestinationLiquidityTa";
          ...
          },
          {
            ...
            docs: ["Inner padding, for alignment."];
            type: {
              array: ["u8", 7];
            };
          },
          {
            name: "endPadding";
            docs: ["Trailing padding, for future developments."];
            type: {
              array: ["u64", 48];
            };
          }
