...
/// Bank opt-in bit: set when same-asset e-mode may use this bank. Uses bit 11 because bits 9-10
/// are reserved for the `STAKED_ORACLE_*` flags below.
pub const BANK_SAME_ASSET_EMODE_ELIGIBLE: u64 = 1 << 11;
