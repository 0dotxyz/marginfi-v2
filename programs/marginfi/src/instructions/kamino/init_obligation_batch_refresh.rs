...
/// Initialize a Kamino obligation for a marginfi account using batch refresh
pub fn kamino_init_obligation_batch_refresh(
    ...
    msg!(
        "Kamino obligation initialized with amount: {}",
        amount
    );
...
#[derive(Accounts)]
pub struct KaminoInitObligationBatchRefresh<'info> {
...
impl<'info> KaminoInitObligationBatchRefresh<'info> {
