...
use marginfi_type_crate::{
    constants::{
        ...
        LIQUIDITY_VAULT_SEED, MAX_LIQUIDATION_FEE_BPS, PERMISSIONLESS_BAD_DEBT_SETTLEMENT_FLAG,
...
impl BankImpl for Bank {
    ...
    fn init(
        ...
        self.liquidation_liquidator_fee_bps = 0;
        self.liquidation_insurance_fee_bps = 0;
    }
